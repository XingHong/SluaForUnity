...
public class Lua_UnityEngine_Sprite : LuaObject {
	...
	[UnityEngine.Scripting.Preserve]
	static public int GetSecondaryTextureCount(IntPtr l) {
		try {
			#if DEBUG
			...
			var ret=self.GetSecondaryTextureCount();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetSecondaryTextures(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			UnityEngine.Sprite self=(UnityEngine.Sprite)checkSelf(l);
			UnityEngine.SecondarySpriteTexture[] a1;
			checkArray(l,2,out a1);
			var ret=self.GetSecondaryTextures(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int Create_s(IntPtr l) {
		try {
			...
			if(argc==3){
				...
				System.Boolean a8;
				checkType(l,8,out a8);
				UnityEngine.SecondarySpriteTexture[] a9;
				checkArray(l,9,out a9);
				var ret=UnityEngine.Sprite.Create(a1,a2,a3,a4,a5,a6,a7,a8,a9);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,GetSecondaryTextureCount);
		addMember(l,GetSecondaryTextures);
