...
public class Lua_UnityEngine_ModifiableContactPair : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_bodyVelocity(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_bodyAngularVelocity(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushValue(l,self.bodyAngularVelocity);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_otherBodyVelocity(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushValue(l,self.otherBodyVelocity);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_otherBodyAngularVelocity(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushValue(l,self.otherBodyAngularVelocity);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"bodyVelocity",get_bodyVelocity,null,true);
		addMember(l,"bodyAngularVelocity",get_bodyAngularVelocity,null,true);
		addMember(l,"otherBodyVelocity",get_otherBodyVelocity,null,true);
		addMember(l,"otherBodyAngularVelocity",get_otherBodyAngularVelocity,null,true);
