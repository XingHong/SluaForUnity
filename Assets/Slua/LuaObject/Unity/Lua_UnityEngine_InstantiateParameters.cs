...
public class Lua_UnityEngine_InstantiateParameters : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.InstantiateParameters o;
			o=new UnityEngine.InstantiateParameters();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_parent(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.InstantiateParameters self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.InstantiateParameters");
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.InstantiateParameters),typeof(System.ValueType));
	}
}
