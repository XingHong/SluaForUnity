...
public class Lua_UnityEngine_SystemInfo : LuaObject {
	...
	static public int get_foveatedRenderingCaps(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.SystemInfo.foveatedRenderingCaps);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_maxConstantBufferSize(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.SystemInfo.maxConstantBufferSize);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_supportsMultisampleResolveStencil(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.SystemInfo.supportsMultisampleResolveStencil);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int get_supportsIndirectArgumentsBuffer(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.SystemInfo.supportsIndirectArgumentsBuffer);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
