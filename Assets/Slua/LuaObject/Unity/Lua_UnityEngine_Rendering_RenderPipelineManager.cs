...
public class Lua_UnityEngine_Rendering_RenderPipelineManager : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_pipelineSwitchCompleted(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Rendering.RenderPipelineManager.pipelineSwitchCompleted);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"pipelineSwitchCompleted",get_pipelineSwitchCompleted,null,false);
