...
public class Lua_UnityEngine_ArticulationDrive : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_driveType(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_driveType(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.ArticulationDrive self;
			checkValueType(l,1,out self);
			UnityEngine.ArticulationDriveType v;
			v = (UnityEngine.ArticulationDriveType)LuaDLL.luaL_checkinteger(l, 2);
			self.driveType=v;
			setBack(l,self);
			pushValue(l,true);
			return 1;
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"driveType",get_driveType,set_driveType,true);
