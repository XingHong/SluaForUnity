...
public class Lua_UnityEngine_GameObject : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetComponentCount(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			UnityEngine.GameObject self=(UnityEngine.GameObject)checkSelf(l);
			var ret=self.GetComponentCount();
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetComponentAtIndex(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(matchType(l,argc,2,typeof(int))){
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				var ret=self.GetComponentAtIndex(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				System.Int32 a1;
				checkType(l,2,out a1);
				var ret=self.GetComponentAtIndex<UnityEngine.Component>(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function GetComponentAtIndex to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetComponentIndex(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkType(l,2,out a1);
			var ret=self.GetComponentIndex(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int SetGameObjectsActive_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(Unity.Collections.NativeArray<System.Int32>),typeof(bool))){
				Unity.Collections.NativeArray<System.Int32> a1;
				checkValueType(l,1,out a1);
				System.Boolean a2;
				checkType(l,2,out a2);
				UnityEngine.GameObject.SetGameObjectsActive(a1,a2);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(System.ReadOnlySpan<System.Int32>),typeof(bool))){
				System.ReadOnlySpan<System.Int32> a1;
				System.Int32[] a1_temp;
				checkArray(l, 1, out a1_temp);
				a1=a1_temp.AsSpan();
				System.Boolean a2;
				checkType(l,2,out a2);
				UnityEngine.GameObject.SetGameObjectsActive(a1,a2);
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function SetGameObjectsActive to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int InstantiateGameObjects_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			Unity.Collections.NativeArray<System.Int32> a4;
			checkValueType(l,4,out a4);
			UnityEngine.SceneManagement.Scene a5;
			checkValueType(l,5,out a5);
			UnityEngine.GameObject.InstantiateGameObjects(a1,a2,a3,a4,a5);
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetScene_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Int32 a1;
			checkType(l,1,out a1);
			var ret=UnityEngine.GameObject.GetScene(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,GetComponentCount);
		addMember(l,GetComponentAtIndex);
		addMember(l,GetComponentIndex);
		...
		addMember(l,SetGameObjectsActive_s);
		addMember(l,InstantiateGameObjects_s);
		addMember(l,GetScene_s);
