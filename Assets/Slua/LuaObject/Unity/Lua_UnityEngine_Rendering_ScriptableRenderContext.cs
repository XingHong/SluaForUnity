...
public class Lua_UnityEngine_Rendering_ScriptableRenderContext : LuaObject {
	...
	static public int BeginRenderPass(IntPtr l) {
		try {
			...
			if(argc==6){
				...
				Unity.Collections.NativeArray<UnityEngine.Rendering.AttachmentDescriptor> a5;
				checkValueType(l,6,out a5);
				System.Int32 a6;
				checkType(l,7,out a6);
				self.BeginRenderPass(a1,a2,a3,a4,a5,a6);
				pushValue(l,true);
				setBack(l,self);
				return 1;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function BeginRenderPass to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int CreateRendererList(IntPtr l) {
		try {
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,2,typeof(UnityEngine.Rendering.RendererUtils.RendererListDesc))){
				UnityEngine.Rendering.ScriptableRenderContext self;
				checkValueType(l,1,out self);
			...
			else if(matchType(l,argc,2,typeof(UnityEngine.Rendering.RendererListParams))){
				UnityEngine.Rendering.ScriptableRenderContext self;
				checkValueType(l,1,out self);
				UnityEngine.Rendering.RendererListParams a1;
				checkValueType(l,2,out a1);
				var ret=self.CreateRendererList(ref a1);
				pushValue(l,true);
				pushValue(l,ret);
				pushValue(l,a1);
				return 3;
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function CreateRendererList to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int CreateShadowRendererList(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Rendering.ShadowDrawingSettings a1;
			checkValueType(l,2,out a1);
			var ret=self.CreateShadowRendererList(ref a1);
			pushValue(l,true);
			pushValue(l,ret);
			pushValue(l,a1);
			return 3;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int CreateSkyboxRendererList(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			if(argc==2){
				...
				UnityEngine.Camera a1;
				checkType(l,2,out a1);
				var ret=self.CreateSkyboxRendererList(a1);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				checkValueType(l,4,out a3);
				var ret=self.CreateSkyboxRendererList(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
				...
				checkValueType(l,6,out a5);
				var ret=self.CreateSkyboxRendererList(a1,a2,a3,a4,a5);
				pushValue(l,true);
				pushValue(l,ret);
				return 2;
			}
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function CreateSkyboxRendererList to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int PrepareRendererListsAsync(IntPtr l) {
		try {
			...
			UnityEngine.Rendering.ScriptableRenderContext self;
			checkValueType(l,1,out self);
			System.Collections.Generic.List<UnityEngine.Rendering.RendererList> a1;
			checkType(l,2,out a1);
	...
	static public int QueryRendererListStatus(IntPtr l) {
		try {
			...
			UnityEngine.Rendering.ScriptableRenderContext self;
			checkValueType(l,1,out self);
			UnityEngine.Rendering.RendererList a1;
			checkValueType(l,2,out a1);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,CreateShadowRendererList);
		addMember(l,CreateSkyboxRendererList);
