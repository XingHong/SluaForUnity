...
public class Lua_UnityEngine_Rendering_RendererUtils_RendererListDesc : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int ConvertToParameters_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			var ret=UnityEngine.Rendering.RendererUtils.RendererListDesc.ConvertToParameters(in a1);
			pushValue(l,true);
			pushValue(l,ret);
			pushValue(l,a1);
			return 3;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_overrideShader(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushValue(l,self.overrideShader);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_overrideShader(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_overrideShaderPassIndex(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushValue(l,self.overrideShaderPassIndex);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_overrideShaderPassIndex(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Int32 v;
			checkType(l,2,out v);
			self.overrideShaderPassIndex=v;
			setBack(l,self);
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,IsValid);
		addMember(l,ConvertToParameters_s);
		...
		addMember(l,"overrideShader",get_overrideShader,set_overrideShader,true);
		...
		addMember(l,"overrideShaderPassIndex",get_overrideShaderPassIndex,set_overrideShaderPassIndex,true);
