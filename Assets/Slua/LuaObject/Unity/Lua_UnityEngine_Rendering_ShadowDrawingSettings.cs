...
public class Lua_UnityEngine_Rendering_ShadowDrawingSettings : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			UnityEngine.Rendering.BatchCullingProjectionType a3;
			a3 = (UnityEngine.Rendering.BatchCullingProjectionType)LuaDLL.luaL_checkinteger(l, 4);
			o=new UnityEngine.Rendering.ShadowDrawingSettings(a1,a2,a3);
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int set_objectsFilter(IntPtr l) {
		try {
			...
			v = (UnityEngine.ShadowObjectsFilter)LuaDLL.luaL_checkinteger(l, 2);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_projectionType(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushEnum(l,(int)self.projectionType);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_projectionType(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Rendering.ShadowDrawingSettings self;
			checkValueType(l,1,out self);
			UnityEngine.Rendering.BatchCullingProjectionType v;
			v = (UnityEngine.Rendering.BatchCullingProjectionType)LuaDLL.luaL_checkinteger(l, 2);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"projectionType",get_projectionType,set_projectionType,true);
