...
public class Lua_UnityEngine_Gradient : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_colorSpace(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Gradient self=(UnityEngine.Gradient)checkSelf(l);
			pushValue(l,true);
			pushEnum(l,(int)self.colorSpace);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_colorSpace(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			v = (UnityEngine.ColorSpace)LuaDLL.luaL_checkinteger(l, 2);
			self.colorSpace=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"colorSpace",get_colorSpace,set_colorSpace,true);
