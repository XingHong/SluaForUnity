...
public class Lua_UnityEngine_OverlapCapsuleCommand : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			UnityEngine.OverlapCapsuleCommand o;
			if(argc==5){
				...
				UnityEngine.QueryParameters a4;
				checkValueType(l,5,out a4);
				o=new UnityEngine.OverlapCapsuleCommand(a1,a2,a3,a4);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new UnityEngine.OverlapCapsuleCommand(a1,a2,a3,a4,a5);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(argc==0){
				o=new UnityEngine.OverlapCapsuleCommand();
				pushValue(l,true);
				pushObject(l,o);
				return 2;
			}
	...
	static public int ScheduleBatch_s(IntPtr l) {
		try {
			...
			#endif
			#endif
			Unity.Collections.NativeArray<UnityEngine.OverlapCapsuleCommand> a1;
			checkValueType(l,1,out a1);
			Unity.Collections.NativeArray<UnityEngine.ColliderHit> a2;
			...
			var ret=UnityEngine.OverlapCapsuleCommand.ScheduleBatch(a1,a2,a3,a4,a5);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int get_queryParameters(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.OverlapCapsuleCommand self;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_point0(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_point0(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
