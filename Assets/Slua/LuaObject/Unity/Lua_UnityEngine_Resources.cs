...
public class Lua_UnityEngine_Resources : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int InstanceIDIsValid_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			System.Int32 a1;
			checkType(l,1,out a1);
			var ret=UnityEngine.Resources.InstanceIDIsValid(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int InstanceIDsToValidArray_s(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			int argc = LuaDLL.lua_gettop(l);
			if(matchType(l,argc,1,typeof(Unity.Collections.NativeArray<System.Int32>),typeof(Unity.Collections.NativeArray<System.Boolean>))){
				Unity.Collections.NativeArray<System.Int32> a1;
				checkValueType(l,1,out a1);
				Unity.Collections.NativeArray<System.Boolean> a2;
				checkValueType(l,2,out a2);
				UnityEngine.Resources.InstanceIDsToValidArray(a1,a2);
				pushValue(l,true);
				return 1;
			}
			else if(matchType(l,argc,1,typeof(System.ReadOnlySpan<System.Int32>),typeof(System.Span<System.Boolean>))){
				System.ReadOnlySpan<System.Int32> a1;
				System.Int32[] a1_temp;
				checkArray(l, 1, out a1_temp);
				a1=a1_temp.AsSpan();
				System.Span<System.Boolean> a2;
				System.Boolean[] a2_temp;
				checkArray(l, 2, out a2_temp);
				a2=a2_temp.AsSpan();
				UnityEngine.Resources.InstanceIDsToValidArray(a1,a2);
				pushValue(l,true);
				return 1;
			...
			pushValue(l,false);
			LuaDLL.lua_pushstring(l,"No matched override function InstanceIDsToValidArray to call");
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,InstanceIDIsValid_s);
		addMember(l,InstanceIDsToValidArray_s);
