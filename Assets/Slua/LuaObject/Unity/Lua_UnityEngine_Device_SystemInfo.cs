...
public class Lua_UnityEngine_Device_SystemInfo : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_foveatedRenderingCaps(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Device.SystemInfo.foveatedRenderingCaps);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_maxConstantBufferSize(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.maxConstantBufferSize);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_supportsMultisampleResolveStencil(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.supportsMultisampleResolveStencil);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_supportsIndirectArgumentsBuffer(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Device.SystemInfo.supportsIndirectArgumentsBuffer);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"foveatedRenderingCaps",get_foveatedRenderingCaps,null,false);
		...
		addMember(l,"maxConstantBufferSize",get_maxConstantBufferSize,null,false);
		...
		addMember(l,"supportsMultisampleResolveStencil",get_supportsMultisampleResolveStencil,null,false);
		addMember(l,"supportsIndirectArgumentsBuffer",get_supportsIndirectArgumentsBuffer,null,false);
