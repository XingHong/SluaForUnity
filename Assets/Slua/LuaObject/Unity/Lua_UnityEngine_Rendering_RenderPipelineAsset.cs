...
public class Lua_UnityEngine_Rendering_RenderPipelineAsset : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_renderPipelineShaderTag(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Rendering.RenderPipelineAsset self=(UnityEngine.Rendering.RenderPipelineAsset)checkSelf(l);
			pushValue(l,true);
			pushValue(l,self.renderPipelineShaderTag);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"renderPipelineShaderTag",get_renderPipelineShaderTag,null,true);
