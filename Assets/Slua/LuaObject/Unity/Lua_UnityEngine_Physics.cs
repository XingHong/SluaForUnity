...
public class Lua_UnityEngine_Physics : LuaObject {
	...
	static public int BakeMesh_s(IntPtr l) {
		try {
			...
			if(argc==2){
				...
				System.Boolean a2;
				checkType(l,2,out a2);
				UnityEngine.MeshColliderCookingOptions a3;
				a3 = (UnityEngine.MeshColliderCookingOptions)LuaDLL.luaL_checkinteger(l, 3);
				UnityEngine.Physics.BakeMesh(a1,a2,a3);
				pushValue(l,true);
				return 1;
			}
			pushValue(l,false);
	...
	static public int get_simulationMode(IntPtr l) {
		try {
			...
			#endif
			pushValue(l,true);
			pushEnum(l,(int)UnityEngine.Physics.simulationMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	static public int set_simulationMode(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.SimulationMode v;
			v = (UnityEngine.SimulationMode)LuaDLL.luaL_checkinteger(l, 2);
			UnityEngine.Physics.simulationMode=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_invokeCollisionCallbacks(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			pushValue(l,true);
			pushValue(l,UnityEngine.Physics.invokeCollisionCallbacks);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_invokeCollisionCallbacks(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			bool v;
			checkType(l,2,out v);
			UnityEngine.Physics.invokeCollisionCallbacks=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"invokeCollisionCallbacks",get_invokeCollisionCallbacks,set_invokeCollisionCallbacks,false);
