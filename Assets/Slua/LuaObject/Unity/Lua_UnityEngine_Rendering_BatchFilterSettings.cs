...
public class Lua_UnityEngine_Rendering_BatchFilterSettings : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.Rendering.BatchFilterSettings o;
			o=new UnityEngine.Rendering.BatchFilterSettings();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_renderingLayerMask(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.Rendering.BatchFilterSettings self;
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_motionMode(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushEnum(l,(int)self.motionMode);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_motionMode(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_allDepthSorted(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			checkValueType(l,1,out self);
			pushValue(l,true);
			pushValue(l,self.allDepthSorted);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_allDepthSorted(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.Rendering.BatchFilterSettings");
		...
		addMember(l,"motionMode",get_motionMode,set_motionMode,true);
		...
		addMember(l,"allDepthSorted",get_allDepthSorted,set_allDepthSorted,true);
		createTypeMetatable(l,constructor, typeof(UnityEngine.Rendering.BatchFilterSettings),typeof(System.ValueType));
	}
}
