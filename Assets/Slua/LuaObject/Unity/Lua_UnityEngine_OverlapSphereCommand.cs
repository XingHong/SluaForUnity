...
public class Lua_UnityEngine_OverlapSphereCommand : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			UnityEngine.OverlapSphereCommand o;
			if(argc==4){
				UnityEngine.Vector3 a1;
				checkType(l,2,out a1);
				System.Single a2;
				checkType(l,3,out a2);
				UnityEngine.QueryParameters a3;
				checkValueType(l,4,out a3);
				o=new UnityEngine.OverlapSphereCommand(a1,a2,a3);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new UnityEngine.OverlapSphereCommand(a1,a2,a3,a4);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(argc==0){
				o=new UnityEngine.OverlapSphereCommand();
				pushValue(l,true);
				pushObject(l,o);
				return 2;
			}
	...
	static public int ScheduleBatch_s(IntPtr l) {
		try {
			...
			#endif
			#endif
			Unity.Collections.NativeArray<UnityEngine.OverlapSphereCommand> a1;
			...
			var ret=UnityEngine.OverlapSphereCommand.ScheduleBatch(a1,a2,a3,a4,a5);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int get_queryParameters(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.OverlapSphereCommand self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.OverlapSphereCommand");
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.OverlapSphereCommand),typeof(System.ValueType));
	}
}
