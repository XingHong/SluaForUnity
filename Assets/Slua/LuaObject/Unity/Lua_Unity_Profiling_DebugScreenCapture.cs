...
public class Lua_Unity_Profiling_DebugScreenCapture : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			Unity.Profiling.DebugScreenCapture o;
			o=new Unity.Profiling.DebugScreenCapture();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_RawImageDataReference(IntPtr l) {
		try {
			...
			#endif
			#endif
			Unity.Profiling.DebugScreenCapture self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"Unity.Profiling.DebugScreenCapture");
		...
		createTypeMetatable(l,constructor, typeof(Unity.Profiling.DebugScreenCapture),typeof(System.ValueType));
	}
}
