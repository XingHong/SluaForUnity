...
public class Lua_UnityEngine_SortingLayer : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onLayerAdded(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			#endif
			UnityEngine.SortingLayer.LayerCallback v;
			int op=checkDelegate(l,2,out v);
			if(op==0) UnityEngine.SortingLayer.onLayerAdded=v;
			else if(op==1) UnityEngine.SortingLayer.onLayerAdded+=v;
			else if(op==2) UnityEngine.SortingLayer.onLayerAdded-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_onLayerRemoved(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.SortingLayer.LayerCallback v;
			int op=checkDelegate(l,2,out v);
			if(op==0) UnityEngine.SortingLayer.onLayerRemoved=v;
			else if(op==1) UnityEngine.SortingLayer.onLayerRemoved+=v;
			else if(op==2) UnityEngine.SortingLayer.onLayerRemoved-=v;
			pushValue(l,true);
			return 1;
		}
		catch(Exception e) {
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"onLayerAdded",null,set_onLayerAdded,false);
		addMember(l,"onLayerRemoved",null,set_onLayerRemoved,false);
