...
public class Lua_UnityEngine_Search_SearchViewFlags : LuaObject {
	static public void reg(IntPtr l) {
		...
		addMember(l,33560576,"ContextSwitchPreservedMask");
		addMember(l,67108864,"DisableQueryHelpers");
		addMember(l,134217728,"DisableNoResultTips");
		addMember(l,268435456,"IgnoreSavedSearches");
		addMember(l,536870912,"ObjectPicker");
		addMember(l,1073741824,"ObjectPickerAdvancedUI");
		LuaDLL.lua_pop(l, 1);
	}
}
