...
public class Lua_UnityEngine_Animations_TransformSceneHandle : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetLocalToParentMatrix(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Animations.AnimationStream a1;
			checkValueType(l,2,out a1);
			var ret=self.GetLocalToParentMatrix(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int GetLocalToWorldMatrix(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Animations.AnimationStream a1;
			checkValueType(l,2,out a1);
			var ret=self.GetLocalToWorldMatrix(a1);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,GetLocalToParentMatrix);
		addMember(l,GetGlobalTR);
		addMember(l,GetLocalToWorldMatrix);
