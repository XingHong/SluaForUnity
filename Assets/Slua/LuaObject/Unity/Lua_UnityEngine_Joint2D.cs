...
public class Lua_UnityEngine_Joint2D : LuaObject {
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int get_breakAction(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			UnityEngine.Joint2D self=(UnityEngine.Joint2D)checkSelf(l);
			pushValue(l,true);
			pushEnum(l,(int)self.breakAction);
			return 2;
		}
		catch(Exception e) {
			return error(l,e);
	...
	[SLua.MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	[UnityEngine.Scripting.Preserve]
	static public int set_breakAction(IntPtr l) {
		try {
			#if DEBUG
			var method = System.Reflection.MethodBase.GetCurrentMethod();
			string methodName = GetMethodName(method);
			...
			#endif
			UnityEngine.Joint2D self=(UnityEngine.Joint2D)checkSelf(l);
			UnityEngine.JointBreakAction2D v;
			v = (UnityEngine.JointBreakAction2D)LuaDLL.luaL_checkinteger(l, 2);
			self.breakAction=v;
			pushValue(l,true);
			return 1;
		}
	...
	static public void reg(IntPtr l) {
		...
		addMember(l,"breakAction",get_breakAction,set_breakAction,true);
