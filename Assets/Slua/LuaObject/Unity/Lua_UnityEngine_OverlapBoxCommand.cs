...
public class Lua_UnityEngine_OverlapBoxCommand : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			UnityEngine.OverlapBoxCommand o;
			if(argc==5){
				...
				o=new UnityEngine.OverlapBoxCommand(a1,a2,a3,a4);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
				...
				o=new UnityEngine.OverlapBoxCommand(a1,a2,a3,a4,a5);
				pushValue(l,true);
				pushValue(l,o);
				return 2;
			}
			else if(argc==0){
				o=new UnityEngine.OverlapBoxCommand();
				pushValue(l,true);
				pushObject(l,o);
				return 2;
			}
	...
	static public int ScheduleBatch_s(IntPtr l) {
		try {
			...
			#endif
			#endif
			Unity.Collections.NativeArray<UnityEngine.OverlapBoxCommand> a1;
			...
			var ret=UnityEngine.OverlapBoxCommand.ScheduleBatch(a1,a2,a3,a4,a5);
			pushValue(l,true);
			pushValue(l,ret);
			return 2;
		}
	...
	static public int get_queryParameters(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.OverlapBoxCommand self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.OverlapBoxCommand");
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.OverlapBoxCommand),typeof(System.ValueType));
	}
}
