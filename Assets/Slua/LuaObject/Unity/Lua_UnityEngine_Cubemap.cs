...
public class Lua_UnityEngine_Cubemap : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			else if(matchType(l,argc,2,typeof(int),typeof(UnityEngine.Experimental.Rendering.DefaultFormat),typeof(UnityEngine.Experimental.Rendering.TextureCreationFlags),typeof(int))){
				System.Int32 a1;
				checkType(l,2,out a1);
				UnityEngine.Experimental.Rendering.DefaultFormat a2;
				a2 = (UnityEngine.Experimental.Rendering.DefaultFormat)LuaDLL.luaL_checkinteger(l, 3);
			...
			else if(matchType(l,argc,2,typeof(int),typeof(UnityEngine.Experimental.Rendering.GraphicsFormat),typeof(UnityEngine.Experimental.Rendering.TextureCreationFlags),typeof(int))){
				System.Int32 a1;
				checkType(l,2,out a1);
				UnityEngine.Experimental.Rendering.GraphicsFormat a2;
				a2 = (UnityEngine.Experimental.Rendering.GraphicsFormat)LuaDLL.luaL_checkinteger(l, 3);
			...
			else if(matchType(l,argc,2,typeof(int),typeof(UnityEngine.TextureFormat),typeof(bool),typeof(bool))){
				System.Int32 a1;
				checkType(l,2,out a1);
				UnityEngine.TextureFormat a2;
				a2 = (UnityEngine.TextureFormat)LuaDLL.luaL_checkinteger(l, 3);
			...
			else if(matchType(l,argc,2,typeof(int),typeof(UnityEngine.TextureFormat),typeof(int),typeof(bool))){
				System.Int32 a1;
				checkType(l,2,out a1);
				UnityEngine.TextureFormat a2;
				a2 = (UnityEngine.TextureFormat)LuaDLL.luaL_checkinteger(l, 3);
