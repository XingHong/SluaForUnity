...
public class Lua_UnityEngine_ContactPairPoint : LuaObject {
	...
	static public int constructor(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.ContactPairPoint o;
			o=new UnityEngine.ContactPairPoint();
			pushValue(l,true);
			pushValue(l,o);
			return 2;
		}
	...
	static public int get_Position(IntPtr l) {
		try {
			...
			#endif
			#endif
			UnityEngine.ContactPairPoint self;
	...
	static public void reg(IntPtr l) {
		getTypeTable(l,"UnityEngine.ContactPairPoint");
		...
		createTypeMetatable(l,constructor, typeof(UnityEngine.ContactPairPoint),typeof(System.ValueType));
	}
}
